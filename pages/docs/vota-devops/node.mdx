...
| vota-vk      | 8 cores | 32GB | 500GB NVME |
...
{/* prettier-ignore */}
<Tabs items={['Mainnet', 'Incentivized Testnet', 'Testnet']}>
  <Tabs.Tab>
  ```shell
...
- Incentivized Testnet: Replace the genesis file in `~/.dora/config` with the [Dora Vota Incentivized genesis file](https://github.com/DoraFactory/doravota/blob/main/config/incentivized/genesis.json).
...
<Tabs items={['Mainnet', 'Incentivized Testnet', 'Testnet']}>
  ...
  ```shell
  # Comma separated list of seed nodes to connect to
  seeds = "43544871409922af8fbf80723aa1c9cbfba26c25@18.143.75.85:26656, f185cdfe3345535cccb6af40069abd94f98b4b38@13.213.30.203:26656"
  
  # Comma separated list of nodes to keep persistent connections to
  persistent_peers = "43544871409922af8fbf80723aa1c9cbfba26c25@18.143.75.85:26656, f185cdfe3345535cccb6af40069abd94f98b4b38@13.213.30.203:26656"
  ```
  </Tabs.Tab>
  <Tabs.Tab>
  ```shell
