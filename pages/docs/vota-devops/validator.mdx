...
desc: 'This guide describes how to set up a Dora Vota validator.'
---
...
This guide describes how to set up a Dora Vota validator.
...
<Callout type="info">
  In the current Dora Vota network, there are **no mint rewards** because the
...
```shell
dorad query bank balances $ACCOUNT_ADDRESS
```
