...
<Callout type="info">
  For the **mainnet**, you can also use other snpshot:
  - [Polkachu Snapshot](https://polkachu.com/tendermint_snapshots/dora)
  - [ITRocket Snapshot](https://itrocket.net/services/mainnet/doravota/)
</Callout>
