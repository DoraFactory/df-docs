...
- **100% of the total service fee** (i.e., the entire operator service provider fee) will be refunded if the tally is not completed within **96 hours** after the round ends.
