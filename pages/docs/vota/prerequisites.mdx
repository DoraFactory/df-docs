...
- **cURL**: A command line tool and library for transferring data with URLs. Please follow the [official guide](https://curl.se/download.html) to download and install it.
- **jq**: A lightweight and flexible command-line JSON processor. Please follow the [official guide](https://stedolan.github.io/jq/download/) to download and install it.
