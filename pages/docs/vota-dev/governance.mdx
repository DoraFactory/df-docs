...
<Callout type="error">
  ...
  deposits are burned**. The `MinDeposit` of Vota Mainnet is
  **100,000,000,000,000,000,000,000 peaka**, i.e., **100,000 DORA**.
</Callout>

You can execute this command to contribute your deposit to anyone proposal:
...
A user can query a deposit made by a specific address on a specific proposal. This can be used to see your current deposit amount or to see the amount another account deposited.
