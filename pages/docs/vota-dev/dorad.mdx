...
<Tabs items={['Mainnet', 'Incentivized Testnet']}>
  ...
  <Tabs.Tab>
  ```ansi filename="Terminal"
  $ dorad tx bank send <from_addr> <to_addr> <amount> --chain-id vota-vk --gas-prices=100000000000peaka --gas=auto --gas-adjustment=1.5 --node https://vota-vk-rpc.dorafactory.org:443
  ```
  </Tabs.Tab>
</Tabs>
