...
- Incentivized Testnet, identified with the chain ID: `vota-vk`
...
- Incentivized Testnet: [`vota-vk`](https://github.com/DoraFactory/doravota/blob/main/config/incentivized/genesis.json)
...
<Tabs items={['Mainnet', 'Testnet', 'Incentivized Testnet']}>
  ...
  <Tabs.Tab>
    ```text
    https://vota-vk-rpc.dorafactory.org:443
    ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Mainnet', 'Testnet', 'Incentivized Testnet']}>
  ...
  <Tabs.Tab>
    ```text
    vota-vk-grpc.dorafactory.org:443
    ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Mainnet', 'Testnet', 'Incentivized Testnet']}>
  ...
  <Tabs.Tab>
    ```text
    https://vota-vk-rest-api.dorafactory.org:443
    ```
  </Tabs.Tab>
</Tabs>
...
- Incentivized Testnet: https://vota-vk-explorer.dorafactory.org
